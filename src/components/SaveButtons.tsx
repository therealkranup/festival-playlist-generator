...
export default function SaveButtons({
  ...
  const importVia = (destination: "spotify" | "youtube") => {
    ...
    const urls = {
      ...
      youtube: "https://www.tunemymusic.com/transfer/text-file-to-youtube",
    };
  ...
  return (
    <>
      <div className="w-full max-w-3xl mx-auto mt-8 space-y-3">
        ...
        {/* Import via TuneMyMusic — two buttons side by side */}
        <div className="flex gap-2">
          <button
            onClick={() => importVia("spotify")}
            className="flex-1 py-2.5 bg-[#1DB954]/10 hover:bg-[#1DB954]/20 border border-[#1DB954]/30
          ...
          <button
            onClick={() => importVia("youtube")}
            className="flex-1 py-2.5 bg-[#FF0000]/10 hover:bg-[#FF0000]/20 border border-[#FF0000]/30
                       text-[#FF0000] text-sm rounded-xl transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
        ...
        <p className="text-center text-white/30 text-xs -mt-1">via TuneMyMusic — free, no login needed</p>
